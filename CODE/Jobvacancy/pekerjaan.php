...
<nav class="navbar navbar-expand-lg fixed-top navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
        <a class="nav-link" href="http://localhost/projectname/beranda.php?#">Beranda</a>
      </li>
    ...
    <div class="col-8">
      ...
      <div class="row">
        <div class="col-7">
          ...
          <!-- <img src="img/locations.png" width="20" height="20"> <a href="
          https://www.google.com/maps/place/CrystalBlue+Cleaning+and+Facility+
          Management+Services/@25.1855533,55.271605,17z/data=!3m1!4b1!4m5!3m4!1s0x
          3e5f6beac09905bd:0xd1664b064245534e!8m2!3d25.1855485!4d55.2737937"> Dubai, UAE <a> -->
          <br>
          ...
          <div>
            ...
            <!-- Modal -->
            <form action="create-pekerjaan.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="row form-group">
                          <div class="form-row align-items-center">
                            ...
                            <div class="col-auto my-1">
                              <select class="custom-select mr-sm-2 form-control" name="provinsi" id="provinsiToSelect" onchange="selectProvinsi()"> <!-- id="inlineFormCustomSelect1" -->
                                <option selected>Provinsi</option>
                            ...
                            <div class="col-auto my-1">
                              <!-- <label class="mr-sm-2" for="inlineFormCustomSelect">Preference</label> -->
                              <select class="custom-select mr-sm-2 form-control" name="perusahaanbiro" id="perusahaanToSelect" onchange="selectPerusahaan()"> <!-- id="inlineFormCustomSelect2" -->
                                <option selected>Perusahaan Biro Jasa</option>
                                <option value="PT AMRITA MAHESA PRIMA">PT AMRITA MAHESA PRIMA</option>
                                <option value="PT DIAN YOGYA PERDANA">PT DIAN YOGYA PERDANA</option>
                                <option value="PT FICOTAMA BINA TERAMPIL">PT FICOTAMA BINA TERAMPIL</option>
                                <option value="PT NUSA SINAR MAKMUR">PT NUSA SINAR MAKMUR</option>
                                <option value="PT TAFCINDO JASATAMA SEGARA">PT TAFCINDO JASATAMA SEGARA</option>
                              </select>
                          ...
                          <script type="text/javascript">
                            function selectProvinsi() {
                              var select = document.getElementById('provinsiToSelect');
                            ...
                            function selectPerusahaan() {
                              var select = document.getElementById('perusahaanToSelect');
                              var option = select.options[select.selectedIndex];
    ...
    <div class="col-4">
      ...
      <div class="card border-dark mb-3" style="max-width: 25rem;">
        ...
        <div class="card-body text-success">
          ...
          <div class="row">
            <div class="col-3">
              <img src="img/logoperusahaantiga.png" width="90" height="60">
            </div>
            <div class="col-9">
              <h6 class="card-title"> <b>Personal Assistant</b></h6>
              <h6><i>PT. Hamura Digital Agency</i></h6>
      ...
      <div class="card border-dark mb-3" style="max-width: 25rem;">
        ...
        <div class="card-body text-success">
          ...
          <div class="row">
            <div class="col-3">
              <img src="img/logoperusahaanempat.jpg" width="90" height="60">
            </div>
            <div class="col-9">
              <h6 class="card-title"> <b>Personal Assistant</b></h6>
