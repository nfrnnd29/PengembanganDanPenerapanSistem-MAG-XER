...
<!-- card produk yang ditawarkan -->

<h5 class="text-center" style="font-size: 20pt;"><b>Yuk, Persiapkan Diri Kalian Dengan Melakukan Pelatihan Bermanfaat Dibawah Ini!</b></h5>
<br>
<div class="row">
  <div class="col-4">
    <div class="card mb-3" style="max-width: 540px;">
      <div class="row no-gutters">
        <div class="col-sm-4">
          <img src="tki1.jpg" class="card-img" alt="kerja timur tengah" height="100%">
        </div>
        <div class="col-md-8">
          <div class="card-body">
            <h5 class="card-title">Persiapan Kerja di Timur Tengah</h5>
            <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
            <a href="#" class="btn btn-info">Lihat lebih detail!</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="col-4">
    <div class="card mb-3" style="max-width: 540px;">
      <div class="row no-gutters">
        <div class="col-sm-4">
          <img src="tki-2.jpg" class="card-img" alt="pelatihan bahasa inggris" height="100%">
        </div>
        <div class="col-md-8">
          <div class="card-body">
            <h5 class="card-title">Bimbingan Lancar Lisan & Tulis Berbahasa Inggris</h5>
            <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
            <a href="http://localhost/magxer/pembayaran.php?#" class="btn btn-info">Lihat lebih detail!</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="col-4">
    <div class="card mb-3" style="max-width: 540px;">
      <div class="row no-gutters">
        <div class="col-sm-4">
          <img src="tki-3.jpg" class="card-img" alt="pelatihan memasak" height="100%">
        </div>
        <div class="col-md-8">
          <div class="card-body">
            <h5 class="card-title">Pelatihan Memasak Ala Juru Koki Handal</h5>
            <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
            <a href="#" class="btn btn-info">Lihat lebih detail!</a>
          </div>
        </div>
